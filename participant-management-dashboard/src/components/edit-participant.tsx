...
export default function EditParticipant({ participant, updated }: { participant: Participant, updated: () => void }) {
  ...
  async function save() {
    try {
      await axios.patch('http://localhost:3001/participants', {
        id: participant.id,
        name,
        email,
        avatar
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input value={participant.id} disabled type="text" name="id" id="id" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5" placeholder="1297" required />
                </div>
                <div className="col-span-6 sm:col-span-3">
