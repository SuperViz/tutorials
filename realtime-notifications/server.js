...
app.post('/notify', (req, res) => {
  ...
  setTimeout(async () => {
    const response = await fetch(`https://nodeapi.superviz.com/realtime/${roomId}/${channel}/publish`, {
      method: 'POST',
      headers: {
    ...
    console.log(`Sending data to ${channel}, message: ${message}`, response.status)
  }, msToWait)
